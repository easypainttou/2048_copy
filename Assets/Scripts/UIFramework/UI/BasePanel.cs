...
namespace UIFramework
{
    public abstract class BasePanel
    {
        ...
        /// 当前活动面板
        /// </summary>
        public Transform PanelTransform { get => panelTransform; set => panelTransform = value; }
        ...
        {
            panelTransform.PanelAppearance(true);
            panelTransform.SetSiblingIndex(panelTransform.parent.childCount - 1);
            if (!ui.IsInit)
            {
                InitEvent();
                ui.IsInit = true;
        ...
        {
            panelTransform.GetOrAddComponent<CanvasGroup>().blocksRaycasts = true;
        }
        ...
        {
            panelTransform.GetOrAddComponent<CanvasGroup>().blocksRaycasts = false;
        }
